    ...
    <div class="col-md-9">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <?= $form->field($model, 'new_password', ['inputTemplate' => '<div class="form-line">{input}</div>'])->passwordInput() ?>

                <?= $form->field($model, 'current_password', ['inputTemplate' => '<div class="form-line">{input}</div>'])->passwordInput() ?>
